...
인터랙티브 데모 **10개** · 실험 **32개** · 사전 등록 주장 **98개**(51 성립 · 32 반증 · 15 부분·보류) · **실측 사이트 12곳**
...
> **r(기준선 FCP, 지연) = −0.88.** `plain` FCP 는 300~800ms 로 **2.7배** 흔들리는데
> cv FCP 는 524~776ms 로 **1.5배**만 흔들린다.
> 기준선이 이르면 지연이 크고, 기준선이 그 바닥까지 늦어지면 지연이 사라진다.

풀링하면(48/셀) **UK +264 [180, 320] · Philippines +248 [136, 320]**, 둘 다 유의하다.
...
<sub>사전 등록 [PREDICTION.md](experiments/track-c/c8-image-lcp/PREDICTION.md) · 전체 결과 [RESULTS.md](experiments/track-c/c8-image-lcp/RESULTS.md) — 결과 파일에 남은 측정 **759행** · 사전 등록 주장 34개 중 **6 반증 · 19 성립 · 6 부분 · 3 판정 불가**</sub>
