...
인터랙티브 데모 **10개** · 실험 **23개** · 사전 등록 주장 **80개**(38 성립 · 29 반증 · 13 부분·보류) · **실측 사이트 12곳**
...
| **이미지가 다 내려온 뒤 LCP 까지의 735ms** | ❌ 미확인. 응답 끝이 FCP 보다 69ms 빠른데도 그리기까지 742~1,047ms 를 더 기다린다. Layout 을 절반으로 줄여도 5~10% 밖에 안 준다 |
