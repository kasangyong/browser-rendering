...
인터랙티브 데모 **10개** · 실험 **24개** · 사전 등록 주장 **80개**(38 성립 · 29 반증 · 13 부분·보류) · **실측 사이트 12곳**
...
③의 426ms 는 **절반만 닫았다.** 그 동안 프레임은 계속 나온다(9~14 프레임, 최대 공백 57~84ms) —
멈춘 게 아니라 느리다. 합성 파이프라인의 어느 단계인지는 못 갈랐다.
...
| **그 78%(426ms)가 합성 파이프라인 어느 단계인가** | ❌ 절반만 닫음. 프레임은 계속 나오지만 12~17fps 로 느리다. 단계 분해는 소스 빌드가 필요하다 |
