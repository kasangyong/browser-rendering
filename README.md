...
인터랙티브 데모 **10개** · 실험 **10개** · 사전 등록 주장 **28개**(14 성립 · 9 반증 · 5 부분·보류)

**내가 틀린 것 7개** · 폐기한 측정법 **4개**
...
| **commit 이 레이어 수에 선형인가** | ⚠️ **판정 보류.** 세 가지 방법 모두 R² < 0.95. vsync 를 꺼도 0.64 |
| 2,000 레이어에서 commit 이 5배 뛰는 이유 | ❌ 미확인. [A2 의 타일 예산 512MB](#a2--합성-레이어의-gpu-메모리) 와 관련일 수 있다는 **가설만** |
